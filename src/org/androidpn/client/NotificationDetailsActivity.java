...
//                notificationUri);
    ...
    private View initViews() {
		...
		initEvents(mArticleView);
		return mArticleView;
	}

	private void initEvents(View view) {
		// TODO Auto-generated method stub
		mArticleTitle.setText(notificationTitle);
		mArticleUserName.setText("系统");
		mArticleTime.setText("刚刚");
		mArticleContent.setText(notificationMessage);
	}
