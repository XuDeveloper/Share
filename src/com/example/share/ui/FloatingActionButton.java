...
public class FloatingActionButton extends ImageButton {
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        TypedArray attr = getTypedArray(context, attributeSet, FABStyleable.styleable.FloatingActionButton);
        if (attr != null) {
            try {
                mColorNormal = attr.getColor(FABStyleable.styleable.FloatingActionButton_fab_colorNormal,
                        getColor(R.color.material_blue_500));
                mColorPressed = attr.getColor(FABStyleable.styleable.FloatingActionButton_fab_colorPressed,
                        darkenColor(mColorNormal));
                mColorRipple = attr.getColor(FABStyleable.styleable.FloatingActionButton_fab_colorRipple,
                        lightenColor(mColorNormal));
                mColorDisabled = attr.getColor(FABStyleable.styleable.FloatingActionButton_fab_colorDisabled,
                        mColorDisabled);
                mShadow = attr.getBoolean(FABStyleable.styleable.FloatingActionButton_fab_shadow, true);
                mType = attr.getInt(FABStyleable.styleable.FloatingActionButton_fab_type, TYPE_NORMAL);
            } finally {
                attr.recycle();
            }
        }
