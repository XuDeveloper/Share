...
public class Classification_ArticleFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.classification_article_xml,
				container, false);
		classification_article_lv = (ListView) rootView
				.findViewById(R.id.classification_article_lv);
		classification_article_fab = (FloatingActionButton) rootView
				.findViewById(R.id.classification_article_fab);
		...
		classification_article_fab.attachToListView(classification_article_lv,
